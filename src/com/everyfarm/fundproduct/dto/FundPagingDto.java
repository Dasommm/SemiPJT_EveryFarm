...
public class FundPagingDto {
	...
	public FundPagingDto() {
		super();
		// TODO Auto-generated constructor stub
	}

	public FundPagingDto(int totalrows, int currentpage, int pagescale, int startpage, int endpage, int pagegroup,
