...
public class FarmPagingDto {
	...
	public FarmPagingDto() {
		
	}

	public FarmPagingDto(int startseq, int endseq, int underpagescale, int pagegroup, int totalpage, int currentpage,
			int column) {
		super();
